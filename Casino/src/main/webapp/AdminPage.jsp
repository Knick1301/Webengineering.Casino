...
<head>
    ...
    <style>
        ...
        .user-list { list-style: none; padding: 0; margin-top: 20px; text-align: left; }
        .user-item { background: rgba(0,0,0,0.3); margin: 10px 0; padding: 15px; border-radius: 10px; display: flex; justify-content: space-between; align-items: center; border: 1px solid #4d5a60; }
        
        .user-info { display: flex; flex-direction: column; }
        .user-name { font-weight: bold; font-size: 1.2rem; color: white; }
        .user-balance { color: #4CAF50; font-size: 0.9rem; margin-top: 5px; }
        
        .delete-btn { background: #d32f2f; color: white; border: none; padding: 8px 15px; border-radius: 6px; cursor: pointer; font-weight: bold; transition: 0.2s; }
        .delete-btn:hover { background: #b71c1c; transform: scale(1.05); }
        
        .back-btn { display: inline-block; margin-top: 20px; padding: 10px 20px; color: #fcc23d; text-decoration: none; border: 1px solid #fcc23d; border-radius: 8px; transition: 0.3s; }
        .back-btn:hover { background: #fcc23d; color: #0f171c; }
    </style>
</head>
<body>
    <div class="container">
        ...
        <a href="LobbyPage.jsp" class="back-btn">Zurück zur Lobby</a>
    </div>
</body>
</html>